...
def write_cac_in(lammps_in, parameters, atoms, prismobj,
...
##following lines were not commented originally 
...
#the following line was not commented originslly        
...
#the following line was not commented originslly
    ...
    fileobj.write(
        "dump dump_all all atom {1} {0} stress no velocity yes force yes style node "
        "\n"
        "".format(lammps_trj.replace("trj0", "trj*"), parameters["dump_period"]).encode("utf-8")
    ...
    #the folowing line was uncomented originally
